...
class TestClient {
  ...
  async updateRefRangeForTest(
    testId: number,
    refRangeId: number,
    data: ReferenceRangeValues
  ) {
    return await clientHttp.patch<ReferenceRange>(
      `${this.TESTS_ENDPOINT}/${testId}/reference-ranges/${refRangeId}`,
      data
    );
  }
  async deleteRefRangeForTest(testId: number, refRangeId: number) {
    return await clientHttp.delete<true>(
      `${this.TESTS_ENDPOINT}/${testId}/reference-ranges/${refRangeId}`
    );
  }
  ...
  async updateResultOptionsForTest(
    ...
    return await clientHttp.patch<ResultValueOption>(
      `${this.TESTS_ENDPOINT}/${testId}/result-value-options/${resultValueOptionId}`,
      data
    );
  }

  async deleteResultOptionsForTest(
    testId: number,
    resultValueOptionId: number
  ) {
    return await clientHttp.delete<true>(
